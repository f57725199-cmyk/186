...
import { Zap, Crown, Calendar, Clock, History, Layout, Gift, Sparkles, Megaphone, Lock, BookOpen, AlertCircle, Edit, Settings, Play, Pause, RotateCcw, MessageCircle, Gamepad2, Timer, CreditCard, Send, CheckCircle, Mail, X, Ban, Smartphone, Trophy, ShoppingBag, ArrowRight, Video, Youtube, Home, User as UserIcon, Book, BookOpenText } from 'lucide-react';
              ...
              <div className="space-y-6 pb-24">
                  ...
                  <div>
                      ...
                      <div className="grid grid-cols-4 gap-3">
                          <button onClick={() => setShowInbox(true)} className="aspect-square bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col items-center justify-center gap-1 hover:bg-slate-50 transition-all relative">
                          ...
                          <button onClick={() => window.open(`mailto:${settings?.supportEmail || 'support@iic.com'}`)} className="aspect-square bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col items-center justify-center gap-1 hover:bg-slate-50 transition-all">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-4">
                        ...
                        <div className="grid gap-3">
                            {[
                                ...
                                "Performance History", "Responsive Design", "PDF Watermarking", "Auto-Sync Content", 
                                "Offline Capabilities", "Guest Access", "Passwordless Login", "Gift Codes", 
                                "Featured Shortcuts", "Notice Board", "External Apps Integration", 
                                "AI Question Generator", "Class Management (6-12)", "Daily Goals"
                            ].map((feat, i) => (
